    ...
    Buf: StableBuffer,
{
    ...
    fn entry(&mut self) -> Entry {
        opcode::Write::new(Fd(self.fd), self.buf.stable_ptr(), self.buf.size() as u32).build()
    }
    ...
    Buf: StableBuffer,
{
    ...
    fn entry(&mut self) -> Entry {
        ...
        opcode::Writev::new(Fd(self.fd), self.iovecs.as_ptr(), self.iovecs.len() as u32).build()
    }
